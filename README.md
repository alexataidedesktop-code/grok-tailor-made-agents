...
### 3. Use inside Grok (after loading)
...
- "Review this contract using the **Contract Intelligence Agent**"

### 4. Quick one-liner in Grok chat
After uploading the Single File and loading:
> "Use the Chief of Staff + Due Diligence Agent to analyze this Brazilian company for investment"
